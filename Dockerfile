...
LABEL io.github.snakemake.conda_env_hash="c56d25328b90e1328a20d00503f0e581ef220e59d9f4361a2278040fd25905bb"

# Step 1: Retrieve conda environments

# Conda environment:
#   source: envs/other.yml
#   prefix: /conda-envs/911696fbecb33b7d2b0676d8b3a1b1ce
#   channels:
#     - conda-forge
#     - bioconda
#     - defaults
...
#     - wget=1.20.1
#     - reportlab=3.5.68
RUN mkdir -p /conda-envs/911696fbecb33b7d2b0676d8b3a1b1ce
COPY envs/other.yml /conda-envs/911696fbecb33b7d2b0676d8b3a1b1ce/environment.yaml

# Conda environment:
#   source: envs/phyloseq.yml
#   prefix: /conda-envs/5c482e05a487f186d931bbc4f8592913
#   channels:
#     - r
#     - conda-forge
#     - bioconda
...
RUN mkdir -p /conda-envs/5c482e05a487f186d931bbc4f8592913
COPY envs/phyloseq.yml /conda-envs/5c482e05a487f186d931bbc4f8592913/environment.yaml

# Conda environment:
#   source: envs/qiime2-2021.8-py38-linux-conda.yml
#   prefix: /conda-envs/462bd0523be2761f5cec9af83bcb539d
#   channels:
...
#     - zstd=1.5.0
#     - bbmap=38.93
RUN mkdir -p /conda-envs/462bd0523be2761f5cec9af83bcb539d
COPY envs/qiime2-2021.8-py38-linux-conda.yml /conda-envs/462bd0523be2761f5cec9af83bcb539d/environment.yaml

# Conda environment:
#   source: envs/quality.yml
#   prefix: /conda-envs/88fc9bd47126f9d94eed06032c35c0fb
#   channels:
#     - bioconda
#     - conda-forge
#   dependencies:
...
RUN mkdir -p /conda-envs/88fc9bd47126f9d94eed06032c35c0fb
COPY envs/quality.yml /conda-envs/88fc9bd47126f9d94eed06032c35c0fb/environment.yaml

# Step 2: Generate conda environments

RUN mamba env create --prefix /conda-envs/911696fbecb33b7d2b0676d8b3a1b1ce --file /conda-envs/911696fbecb33b7d2b0676d8b3a1b1ce/environment.yaml && \
    mamba env create --prefix /conda-envs/5c482e05a487f186d931bbc4f8592913 --file /conda-envs/5c482e05a487f186d931bbc4f8592913/environment.yaml && \
    mamba env create --prefix /conda-envs/462bd0523be2761f5cec9af83bcb539d --file /conda-envs/462bd0523be2761f5cec9af83bcb539d/environment.yaml && \
    mamba env create --prefix /conda-envs/88fc9bd47126f9d94eed06032c35c0fb --file /conda-envs/88fc9bd47126f9d94eed06032c35c0fb/environment.yaml && \
    mamba clean --all -y
